...
from ReinforcementLearning.PolicyGradient import HyperParams
from ReinforcementLearning.PolicyGradient.REINFORCE import REINFORCE
...
if __name__ == "__main__":
    ...
    agent = REINFORCE(state_dim, HyperParams.hidden_dim, action_card, HyperParams.lr, HyperParams.gamma,
                      HyperParams.device)
