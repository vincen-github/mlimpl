...
class Sarsa:
    """
    Sarsa use temporal difference evaluate action value function,
    and reset the greedy policy as ε-greedy in policy improvement.
    """
    ...
    def temporal_difference(self, s):
        ...
        while True:
            ...
            if r == 0:
                env.reset()
            Return += r
            a_prime = self.take_action(s_prime)
