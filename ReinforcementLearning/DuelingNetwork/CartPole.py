...
from ReinforcementLearning.DuelingNetwork import HyperParams
from ReinforcementLearning.DuelingNetwork.DuelingNetwork import DuelingNetwork
...
if __name__ == "__main__":
    ...
    agent = DuelingNetwork(state_dim, HyperParams.vnet_hidden_dim, HyperParams.anet_hidden_dim, action_card,
                           HyperParams.lr, HyperParams.gamma, HyperParams.eps, HyperParams.target_update_frequency,
                           HyperParams.device, HyperParams.update_mode, HyperParams.share)
